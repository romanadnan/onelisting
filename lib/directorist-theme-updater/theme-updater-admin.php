...
class Directorist_Theme_Updater_Admin {
	...
	public function __construct( $config = array(), $strings = array() ) {
		...
		// add_action( 'admin_init', array( $this, 'register_option' ) );  // @modified
		// add_action( 'admin_init', array( $this, 'license_action' ) );  // @modified
		// add_action( 'admin_menu', array( $this, 'license_menu' ) ); // @modified
		// add_action( 'update_option_' . $this->theme_slug . '_license_key', array( $this, 'activate_license' ), 10, 2 );  // @modified
